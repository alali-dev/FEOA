<?php $this->load->view('staff/components/page_head'); ?>
<?php $this->load->view('staff/components/header'); ?>
<?php
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <section>
                        ...
                        <?php echo anchor("staff/user/logout","<i class='icon-off'></i> logout"); ?>
                    </section>
                </div>
            </div>
        </div>
    </section>
<?php $this->load->view('staff/components/footer'); ?>       
