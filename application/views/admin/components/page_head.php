...
<script src="<?php echo site_url('js/jquery.easing.1.3.js'); ?>" type="text/javascript"></script>
<script src="<?php echo site_url('js/bootstrap.js'); ?>"></script>
<script src="<?php echo site_url('js/bootstrap-datepicker.js'); ?>"></script>
<script src="<?php echo site_url('js/jquery.themepunch.revolution.min.js'); ?>" type="text/javascript"></script>
<script src="<?php echo site_url('js/jquery.prettyPhoto.js'); ?>" type="text/javascript"></script>
<script src="<?php echo site_url('js/jquery.jcarousel.min.js'); ?>" type="text/javascript"></script>
<script src="<?php echo site_url('js/jflickrfeed.js'); ?>" type="text/javascript"></script>
<script src="<?php echo site_url('js/selectnav.js'); ?>" type="text/javascript"></script>
<script src="<?php echo site_url('js/menu-lamp.js'); ?>" type="text/javascript"></script>
<script src="<?php echo site_url('js/jquery.touchwipe.min.js'); ?>" type="text/javascript"></script>
<script src="<?php echo site_url('js/home-script.js'); ?>" type="text/javascript"></script></script>
