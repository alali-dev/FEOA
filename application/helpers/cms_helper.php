...
function get_menu ($array, $child = FALSE)
{
	...
	if (count($array)) {
		$str .= $child == FALSE ? '<ul class="menu-lamp hidden-phone" id="menu-lamp">' . PHP_EOL : '<ul class="submenu">' . PHP_EOL;
		...
		foreach ($array as $item) {
			...
			if (isset($item['children']) && count($item['children'])) {
				$str .= '<li>';
				$str .= $active ? '<a class="dropdown active"' : '<a';
				$str .= ' href="' . site_url(e($item['slug'])) . '">' . e($item['title']);
